...
class InferOptions:
    def __init__(self):
        ...
        # self.parser.add_argument('--cfg', type=str, default="./configs/DDAD_kitti.conf")
        self.parser.add_argument('--cfg', type=str,required=True)
        self.parser.add_argument('--pretrain_model', type=str,required=True)
        self.parser.add_argument('--pose_dir', type=str,required=True)
        self.parser.add_argument('--img_dir', type=str,required=True)
        self.parser.add_argument('--calib_yaml', type=str,required=True)
        self.parser.add_argument('--out_dir',type=str,required=True)
